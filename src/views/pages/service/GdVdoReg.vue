...
const check = () => {
  if (
    gdVdoTrgt.value === undefined ||
    gdVdoTtl.value === undefined ||
    gdVdoCn.value === undefined ||
    gdVdoTrgt.value === null ||
    gdVdoTtl.value === null ||
    gdVdoCn.value === null ||
    atchFile.value == null ||
...
const triggerSubmit = async () => {
  ...
  if (pblcnUseYn.value == "노출" || pblcnUseYn.value == "비노출") {
    expsrBgngYmd.value = null;
    expsrEndYmd.value = null;
  }
  ...
  try {
    await axios.post("/guidevideo/create", formData, {
      headers: {
