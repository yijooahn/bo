<template>
  <div class="mg-1">
    <p class="breadcrumb">통계 관리 > 서비스 이용 통계 > 오답노트</p>
    <p class="heading">오답노트</p>
    <table class="table-1">
      <colgroup>
        <col width="10%" />
        <col width="90%" />
    ...
    <div class="stat-chart-container-inner">
      <div>
        <div class="tit"></div>
        <label>AI 학년(학기) 진단 평가 이용률</label>
      </div>
    </div>
      ...
      <table class="table-2 t-c">
        ...
        <thead>
          <tr>
            ...
            <th><span>학년</span></th>
            <th><span>학기</span></th>
            <th><span>배부 총 횟수</span></th>
            <th><span>교사 수(유니크)</span></th>
            <th><span>평균 배부 횟수</span></th>
          </tr>
        </thead>
        <tbody>
          <!-- <tr v-if="!pageable.empty" v-for="(sr, idx) in searchResult" :key="index">-->
          <tr v-for="idx in 10">
            <td><span>초등학교</span></td>
            <td><span>3</span></td>
            <td><span>1</span></td>
            <td><span>500</span></td>
            <td><span>25</span></td>
    ...
    <div class="stat-chart-container-chart">
      ...
      <table class="table-2 t-c">
        ...
        <thead>
          <tr>
            <th><span>No.</span></th>
            <th><span>오답노트 실행 수</span></th>
            <th><span>오답노트 실행 계정</span></th>
            <th><span>오답노트 평균 실행 횟수</span></th>
            <th><span>오답노트 실행 비율</span></th>
          </tr>
        </thead>
        <tbody>
          <!-- <tr v-if="!pageable.empty" v-for="(sr, idx) in searchResult" :key="index">-->
